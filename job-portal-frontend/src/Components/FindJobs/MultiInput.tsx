    ...
    return (
        <Combobox store={combobox} onOptionSubmit={handleValueSelect} withinPortal={false}>
            <Combobox.DropdownTarget>
                <PillsInput
                    variant={"unstyled"}
                    rightSection={<div className={"text-bright-sun-400 p-1 bg-mine-shaft-900 rounded-full ml-2"}> <IconSelector /> </div>}
                    leftSection={<div className={"text-bright-sun-400 p-1 bg-mine-shaft-900 rounded-full mr-2"}> <IconSearch /> </div>}
